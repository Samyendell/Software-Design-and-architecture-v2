...
public class Position {
  ...
  public static Position home(String colour, int homeNumber) {
    return new Position(homeNumber, PositionType.MAIN, 
        "Home (Position " + homeNumber + ")");
  }
  ...
  public static Position tail(String colour, int tailNumber) {
    return new Position(tailNumber, PositionType.TAIL, 
        colour.substring(0, 1).toUpperCase() + tailNumber);
  }
  ...
  public boolean equals(Object o) {
    ...
    return number == position.number && 
           type == position.type && 
           displayName.equals(position.displayName);
  }
